...
export default function CompactInput({
  ...
  return (
    <div 
		...
		>
			<div className='flex flex-row py-0 px-0 h-full rounded-md w-auto'>
				<input
					className={
						"flex-grow p-0 px-3 bg-transparent rounded-md ring-transparent focus-visible:ring-transparent focus-visible:border-none focus:outline-none h-full overflow-hidden"
					}
					// type={type}
				...
				{(type === "password") && (
					<Button variant={"ghost"} type="button" className={cn(
						"border-[3.5px] border-transparent h-auto w-10",
