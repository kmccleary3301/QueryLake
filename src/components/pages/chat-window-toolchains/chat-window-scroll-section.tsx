...
export default function ChatWindowToolchainScrollSection(props : ChatWindowToolchainScrollSectionProps) {
	...
	const displayTestMessage = false;
  ...
  const oldScrollHeight = useRef(0);
	...
	}, [interiorDivSize, props.animateScroll, scrollToBottomHook]);
	...
	}, [props.animateScroll, scrollToBottomHook]);
						...
						<div id="scrollButton" style={{
							...
							{(props.animateScroll === false) && (
								...
								<Button onClick={() => {
									...
									<Icon.ChevronDown size={30} color="#E8E3E3" />
								</Button>
							)}
						</div>
